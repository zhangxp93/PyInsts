...
class KeysightN9020B(KeysightN9030B):
    def __init__(self, address: str = None, config_path="config.yaml", model: str = "N9020B"):
...
if __name__ == '__main__':
    n9020b = KeysightN9020B(config_path="config.yaml", model='N9020B')
    # n9030b.set_cont()
    # time.sleep(5)
    # n9030b.set_single()
