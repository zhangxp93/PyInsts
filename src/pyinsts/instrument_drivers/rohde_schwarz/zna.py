...
class Zna43(BaseInstrument):
    def __init__(self, address: Optional[str] = None, config_path="config.yaml", model: str = "ZNA43"):
    ...
    def save_csv_png(self, filename):
        ...
        :return:
        """
        self.write(f'MMEMory:STORe:TRACe:CHANnel 1,"{filename}.csv"')
        self.write(f'MMEMory:NAME "{filename}.png"')
